  ...
  return (
    <>
      ...
      <div className="min-h-[100vh] bg-white md:mt-[9vh] mt-[2vh] object-cover w-[100vw] flex gap-[4vh] justify-center py-[4vh] flex-wrap text-[#fff] relative">
        <div className="text-black transition-all ease-in-out grid md:grid-cols-4 grid-cols-2 gap-[2vw]">
          {similarItems == "" ? (
            ...
            similarItems.map((e, index) => {
              return (
                <div key={index}>
                  <div className="md:h-[71vh] h-[53vh] shadow-xl flex flex-col items-center gap-[4vh] w-[48vw] md:mt-4 mt-6 md:w-[20vw] overflow-hidden relative border-[#0000001b] border-[1px]">
                    <div onClick={() => tileBtn(e, index)} className="relative">
                      {e.image ? (
                        <img
                        loading="lazy"
                          className="md:h-[34vh] h-[22vh] cursor-pointer md:w-[20vw] w-[100%] object-cover hover:scale-[1.1] hover:rounded-b-[6px] transition duration-300 ease-out"
                          src={e.image}
                        />
                      ) : (
                        <img
                    ...
                    <div className="flex flex-col w-full px-1 md:p-2 md:gap-y-[1vh] gap-y-[0.3vh]">
                      ...
                      {e.category ? (
                        <p className="font-semibold md:text-sm capitalize text-xs">
                          {e.category}
                        </p>
                      ) : (
                        ""
                      ...
                      Price:
                      <span className="md:text-sm text-xs">₹{e.price}</span>
                    </p>
                    }
                      {e.brand ? (
                    ...
                    {users ? (
                      <Link to="/aboutproduct" className="w-full">
                        <button
                          ...
                          className="hover:text-[2.3vh] transition-all ease-out duration-[0.1s] bg-[#FF9F00] hover:bg-[#ff9d00cf] w-[100%] p-[1vh] text-white text-center md:text-base text-sm font-semibold absolute md:bottom-[5.3vh] bottom-9"
                        >
                          Buy Now
                        </button>
                      </Link>
                      ...
                      <button
                        ...
                        className="bg-[#FF9F00] hover:text-[2.3vh] transition-all ease-out duration-[0.1s] hover:bg-[#ff9d00cf] w-[100%] p-[1vh] text-white text-center md:text-base text-sm font-semibold absolute md:bottom-[5.3vh] bottom-9"
                      >
                        Buy Now
                      </button>
                    )}
